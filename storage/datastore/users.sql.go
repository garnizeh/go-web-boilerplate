...
SELECT email, name, roles, password, salt, created_at, updated_at, verified_at, deleted_at FROM users
...
WHERE email = ?
RETURNING email, name, roles, password, salt, created_at, updated_at, verified_at, deleted_at
`
